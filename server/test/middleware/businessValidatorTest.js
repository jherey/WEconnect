...
describe('MIDDLEWARE TESTS', () => {
  describe('Test register business function', () => {
        ...
        chai.request(app)
          ...
          .end((err, res) => {
            expect(res.body).to.have.property('message')
              .eql('No business found for this location!');
    ...
    it(
      'it should return all businesses with the inputed location',
      (done) => {
    ...
    it(
      ...
      (done) => {
        ...
        chai.request(app)
          ...
          .end((err, res) => {
            expect(res.body).to.have.property('message')
              .eql('No business found for this category!');
            expect(res.status).to.equal(404);
            done();
          });
      }
    ...
    it(
      'it should return all businesses with the inputed category',
      (done) => {
